...
DEFAULT_ENVS_DIR = "/ext_hdd2/tsyou/gelab-env/data_engine/amex_sft"
DEFAULT_OUTPUT_PATH = "/ext_hdd2/tsyou/gelab-env/data_engine/sft_amex.json"
...
def generate_trajectory_samples(
    ...
    metadata = ui_structure.get("metadata", {}) or {}
...
def process_single_env(
    ...
    metadata = ui_structure.get("metadata", {}) or {}
    episode_id = metadata.get("episode_id") or ui_structure.get("episode_id") or traj_stem
