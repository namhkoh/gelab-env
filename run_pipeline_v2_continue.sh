#!/usr/bin/bash
# Continuation: retry Stage 1 HF upload, then run Stage 3 train -> eval -> upload -> doc
...
echo ""
echo "=========================================="
echo "v2 CONTINUATION started: $(date)"
echo "=========================================="
...
STAGE1_CKPT="checkpoint/gui_exp/sft_amex_gelab_full/v0-20260407_205023/checkpoint-45"
echo "Stage 1 checkpoint: $STAGE1_CKPT"

# -----------------------------------------------------------------
# Retry Stage 1 HF upload with retry loop
# -----------------------------------------------------------------
echo ""
echo "[1C-retry] Uploading Stage 1 to HF (v2) with retries..."
...
for attempt in range(5):
    ...
    raise RuntimeError("Stage 1 upload failed after 5 attempts")
PY
echo "[1C-retry] Stage 1 upload done at $(date)"
...
# -----------------------------------------------------------------
echo ""
echo "[3C] Uploading Stage 3 to HF (v2) with retries..."
...
for attempt in range(5):
    ...
    raise RuntimeError("Stage 3 upload failed after 5 attempts")
PY
...
echo ""
echo "=========================================="
echo "v2 continuation complete at $(date)"
echo "=========================================="
