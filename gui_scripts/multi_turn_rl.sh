...
export SAVE_NAME="mt_rl" # Unique name for this run
export MODEL_PATH="checkpoints-1000" # 
export DATASET_PATH="datas/mt_rl.json" # 2162
...
WORKER_SCRIPT="gui_scripts/worker_script_grpo_multi_round.sh" # Make sure this path is correct
...
export MEMORY_PER_NODE=$((1024*800)) # Memory in MB
