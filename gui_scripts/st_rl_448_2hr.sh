...
# =============================================================================
# ST-RL Training - FAST 2-HOUR CONFIG with vLLM
# =============================================================================
...
# FAST CONFIG: 2 epochs, 4 generations
export NUM_TRAIN_EPOCHS=2
export LEARNING_RATE=1e-6
export TEMPERATURE=1.2
export TOP_P=1.0
export TOP_K=8
export NUM_GENERATIONS=4  # Reduced from 8
...
# vLLM ENABLED for fast generation
...
LOG_FILE="$BASE_LOG_DIR/st_rl_448_2hr_${time_start}.log"

echo "============================================================"
echo "ST-RL FAST TRAINING (~2 hours)"
echo "============================================================"
echo "Start: $(date)"
echo "Epochs: 2 (vs paper 5)"
echo "Generations: 4 (vs paper 8)"
echo "vLLM: ENABLED"
echo "============================================================"
